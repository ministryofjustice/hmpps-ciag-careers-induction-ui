...
const stubGetFrontEndComponents = (name = 'J. Smith'): SuperAgentRequest =>
  stubFor({
    request: {
      method: 'GET',
      urlPath: '/components',
    ...
    response: {
      ...
      jsonBody: {
        header: {
          html: `
            <header class="connect-dps-common-header" role="banner">
                ...
                <nav aria-label="Account navigation">
                  <ul class="connect-dps-common-header__navigation">
                    ...
                    <li class="connect-dps-common-header__navigation__item">
                      <a data-qa="manageDetails" class="connect-dps-common-header__link" href="/account-details" data-test="manage-account-link" referrerpolicy="no-referrer-when-downgrade">
...
export default { stubGetFrontEndComponents }
